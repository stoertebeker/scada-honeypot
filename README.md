...
- erster browserbasierter `Playwright`-Smoke unter `tests/e2e/test_hmi_service_playwright.py` prueft jetzt `/service/login -> /service/panel -> breaker open -> /alarms` gegen den echten lokalen Runtime-Pfad
