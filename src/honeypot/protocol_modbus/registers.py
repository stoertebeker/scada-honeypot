...
class ReadOnlyRegisterMap:
    """Read-only Registersicht fuer die erste Unit-1-Modbus-Scheibe."""

    def __init__(self, snapshot: PlantSnapshot):
    ...
    def read_holding_registers(
        ...
        *,
        ...
        unit_registers = _build_unit_1_registers(self.snapshot)
...
def _is_supported_unit_1_offset(offset: int) -> bool:
    return offset in IDENTITY_BLOCK or offset in UNIT_1_STATUS_BLOCK or offset in UNIT_1_ALARM_BLOCK
